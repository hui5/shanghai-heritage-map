import { Info, Maximize2, Minimize2, Pin, X, LayoutGrid } from "lucide-react";
import React, {
  useCallback,
  useEffect,
  useLayoutEffect,
...
export const FloatingInfoPanel: React.FC<FloatingInfoPanelProps> = ({
  ...
  }, [pinned, close, activeId, visibleContents, showOverview, toggleOverview]);
